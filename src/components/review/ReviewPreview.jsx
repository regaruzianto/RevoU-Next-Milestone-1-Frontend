...
function ReviewPreview({  reviewCount, value1 = 5, value2 = 5, value3 =5 }) {
  return (
    <div className='flex flex-col justify-center items-center'>
      <div className='flex flex-col justify-center items-center w-[349px] mt-5'>
        ...
        <Link to="/reviews" className='text-[12px] underline place-self-end font-bold text-[#075128]'>View More &gt;</Link>
